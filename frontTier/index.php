<!DOCTYPE html>
<html lang="nl" class="full-height">

    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Educhain - Home</title>
        <!-- Font Awesome -->
    ...
    <body>
        ...
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar">
                <div class="container">
                    <a class="navbar-brand" href="#"><strong>Educhain</strong></a>
		  ...
		  <span class="navbar-toggler-icon"></span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent-7">
                        <ul class="navbar-nav mr-auto smooth-scroll">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#packages">Pakketten</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#testimonials">Recensies</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <!-- Intro Section -->
            <div class="view jarallax" id="home" data-jarallax='{"speed": 0.2}' style="background-image: url('https://mdbootstrap.com/img/Photos/Others/gradient2.png'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                <div class="mask rgba-purple-slight">
                    <div class="container h-100 d-flex justify-content-center align-items-center">
                        <div class="row pt-5 mt-3">
                            <div class="col-md-12 wow fadeIn mb-3">
                                <div class="text-center">
                                    <h1 class="display-4 font-weight-bold mb-5 wow fadeInUp">Welkom!</h1>
                                    </li>
                                    <h5 class="mb-5 wow fadeInUp" data-wow-delay="0.2s">Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...</h5>
                                    <div class="wow fadeInUp smooth-scroll" data-wow-delay="0.4s">
                                        <a class="btn btn-elegant btn-rounded" href="#packages"><i class="fas fa-box-open mr-2"></i> Bekijk onze pakketten</a>
                                    </div>
                                    </ul>
                                </div>
                            </div>
        ...
        <main>
            ...
            <div class="container">
                ...
                <section class="section wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <!--Section heading-->
                    <h1 class="font-weight-bold text-center h1 py-5" id="about">Over ons</h1>
                    <!--Section description-->
                ...
                <section class="text-center my-5 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <!-- Section heading -->
                    <h2 class="h1-responsive font-weight-bold text-center py-5" id="packages">Onze pakketten</h2>
                    <!-- Section description -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <div class="card-circle d-flex justify-content-center align-items-center">
                                            <i class="fas fa-home purple-text"></i>
                                        </div>
                                    </div>

                                    <!-- Price -->
                                    <h2 class="font-weight-bold my-4">&euro;0,00</h2>
                                    ...
                                    <a class="btn btn-purple btn-rounded" onclick="window.location.href='customerForm.php?id=1'">Koop nu!</a>
                        ...
                        <div class="col-lg-4 col-md-6 mb-md-0 mb-4">
                            ...
                            <div class="card purple-gradient">
                                ...
                                <div class="card-body white-text">
                                    ...
                                    <!--Price -->
                                    <h2 class="font-weight-bold my-4">&euro;0,10</h2>
                                    <p>Esse corporis saepe laudantium velit adipisci cumque iste ratione facere non distinctio cupiditate sequi atque.</p>
                                    <a class="btn btn-outline-white btn-rounded" onclick="window.location.href='customerForm.php?id=2'">Koop nu!</a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!--Price -->
                                    <h2 class="font-weight-bold my-4">&euro;0,20</h2>
                                    ...
                                    <a class="btn btn-purple btn-rounded" onclick="window.location.href='customerForm.php?id=3'">Koop nu!</a>
                ...
                <section class="section team-section text-center pb-3 wow fadeIn" id="testimonials" data-wow-delay="0.3s">

                    <!--Section heading-->
                    <h1 class="font-weight-bold text-center h1 py-5">Recensies</h1>
                    <!--Section description-->
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="testimonial">
                                ...
                                <p><i class="fas fa-quote-left"></i> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod eos id officiis hic tenetur quae quaerat ad velit ab hic tenetur.</p>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="testimonial">
                                ...
                                <p><i class="fas fa-quote-left"></i> Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi.</p>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="testimonial">
                                ...
                                <p><i class="fas fa-quote-left"></i> At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti.</p>
