            ...
            <ul class="custom-scrollbar">
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-chevron-right"></i> Klantengegevens<i class="fas fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul class="list-unstyled">
                                    <li><a href="../../logicTier/functions/CustomerTable/Customertable.php" class="waves-effect">CustmomerMatrix</a></li>
                                </ul>
                            </div>
                        </li>
